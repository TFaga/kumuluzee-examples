...
**[File a bug report](https://github.com/TFaga/kumuluzee-examples/issues/)**
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/kumuluzee-examples.git
   # Navigate to the newly cloned directory
   cd kumuluzee-examples
   # Assigns the original repo to a remote called "upstream"
   git remote add upstream https://github.com/tfaga/kumuluzee-examples.git
   ```
